...
def sigclust(X, mc_iters=100, method=2, verbose=True, scale=True,
    ...
    sim_vars = comp_sim_vars(eig_vals, bg_noise_var, method, p_op, ngrains, verbose=verbose)
...
def comp_sim_vars(eig_vals, bg_noise_var, method, p_op, ngrains, verbose=False):
    """
